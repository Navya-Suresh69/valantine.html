...
<body>
    ...
    <div class="wrap">
        <div class="card" id="askCard">
            ...
            <h1><span class="name" id="who">Suresh</span>,<br />will you be my Valentine?
        ...
        <div class="card hidden" id="yayCard">
            ...
            <div class="gifbox">
                <img alt="Celebration" src="C:\Users\Acer\Documents\Navya Resume/Hug gif.gif"/>
            </div>
    ...
    <script>
        ...
        document.getElementById("who").textContent = HUSBAND_NAME;
